...
const Success = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Thank You for Your Payment | Zeniks</title>
        <meta
          name="description"
          content="Your payment was successful! Your rental listing optimization report is on its way. Get ready to boost your property's performance with tailored recommendations."
        />
      </Helmet>
